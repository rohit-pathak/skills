---
name: skill-creator
description: Guide for creating effective skills. Use when OpenCode needs to create a new skill or update an existing skill that extends OpenCode's capabilities with specialized knowledge, workflows, or tool integrations.
---
